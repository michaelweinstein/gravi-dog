...
// Hidden data members.
	...
	private static final long serialVersionUID = 3115239469357941713L;
...
// Exported operations.
	 ...
	 * passing in the item. Time: <I>O</I>(<I>n</I>).
	 * <P>
	 ...
	 * called, and its result is returned. Time: <I>O</I>(<I>n</I>).
	 * <P>
	 * <B><I>Warning:</I></B> If the <TT>action</TT> adds items to or removes
	 * items from the list, the <TT>forEachItemDo()</TT> method's behavior is
	 * not specified.
	...
	/**
	 * Write this list to the given object output stream. Each item stored in
	 * this list must be serializable.
	 *
	...
	/**
	 * Read this list from the given object input stream. Each item stored in
	 * this list must be serializable.
	 *
	 ...
	 *     Thrown if the class of an object in the object input stream cannot be
	 *     found.
	 */
